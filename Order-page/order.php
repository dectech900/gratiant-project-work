...
$sqlCart = "SELECT orders.id, orders.added_on, users.name, users.email, users.phone, orders.total, orders.order_info
FROM orders
 JOIN users ON orders.user_id=users.id WHERE orders.user_id = '$user_id'";
